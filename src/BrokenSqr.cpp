...
BrokenSqr::BrokenSqr(int width, int height, int columns, int rows, bool randomSquare)
{
...
inline bool BrokenSqr::AboveLine(int x, int y, double slope, double intercept)
{
